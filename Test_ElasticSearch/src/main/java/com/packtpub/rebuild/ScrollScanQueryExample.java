 ...
 * @Time 下午3:07:08
 */
public class ScrollScanQueryExample extends ElasticSearchBase {
	...
	public void testTest() {
		...
		SearchResponse searchResponse = client.prepareSearch()
				.setSearchType(SearchType.SCAN).setQuery(matchAllQuery())
				.setSize(100).setScroll(TimeValue.timeValueMinutes(2))
				.execute().actionGet();
